#!/usr/bin/env python2
import sys
sys.path.append('/place/to/caffe/python')
import caffe
...
def save_fc2caffe(weights, biases, fc_param):
    ...
    if fc_param[0].data.shape != weights.shape:
        fc_param[0].data.reshape(weights.shape[0], weights.shape[1])
...
if __name__ == '__main__':
    ...
    # plot graph to png
    plot_graph(output_var, 'resnet34.dot')

    pytorch2caffe(input_var, output_var, 'resnet-34.prototxt', 'resnet-34.caffemodel')
